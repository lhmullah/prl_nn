...
namespace com.linde.DataContext.Mapping
{
    public class prl_income_tax_challanMap : EntityTypeConfiguration<prl_income_tax_challan>
    {
        public prl_income_tax_challanMap()
        {
            ...
            this.ToTable("prl_income_tax_challan", "payroll_system_nn");
            ...
            this.Property(t => t.challan_bank).HasColumnName("challan_bank");
            this.Property(t => t.challan_total_amount).HasColumnName("challan_total_amount");
