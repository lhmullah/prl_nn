...
namespace PayrollWeb.ViewModels
{
    public class IncomeTaxParameterDetail
    {
        ...
        [DisplayName("Max (%) of Investment that is exemted from Tax")]
        public Nullable<decimal> max_inv_exempted_percentage { get; set; }

        [DisplayName("Max amount for max exemted percentage")]
        public Nullable <decimal> max_amount_for_max_exemption_percent { get; set; }

        [DisplayName("Min (%) of Investment that is exemted from Tax")]
        ...
        [DisplayName("Medical not Exceding")]
        public Nullable<decimal> medical_not_exceding { get; set; }

        [DisplayName("Max Amount of Exemption For WPPF")]
