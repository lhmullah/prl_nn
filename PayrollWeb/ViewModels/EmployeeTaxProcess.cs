...
namespace PayrollWeb.ViewModels
{
    public class EmployeeTaxProcess
    {
        ...
        public Nullable<decimal> yearly_taxable_income { get; set; }
        public Nullable<decimal> total_tax_payable { get; set; }
        public Nullable<decimal> inv_rebate { get; set; }
        public Nullable<decimal> paid_total { get; set; }
        public Nullable<decimal> yearly_tax { get; set; }
        public decimal monthly_tax { get; set; }
        public decimal projected_tax { get; set; }
        public decimal onceoff_tax { get; set; }
