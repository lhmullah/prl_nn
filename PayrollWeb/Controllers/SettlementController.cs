    ...
    public class SettlementController : Controller
    {
        ...
        public ActionResult SettementEmpInfo(string id)
        {
            var result = dataContext.prl_employee.AsEnumerable()
                ...
                .Select(x => new
                             {
                                 joining_date = x.prl_employee.joining_date.ToString("yyyy-MM-dd"),
            ...
            if (result != null)
            {
                var discontinueDate = dataContext.prl_employee_discontinue.AsEnumerable().FirstOrDefault(x => x.emp_id == Convert.ToInt32(id)).discontinue_date.Date.ToString("yyyy-MM-dd");
        ...
        private decimal BasicSalaryAmount(string id, DateTime dt2, DateTime dt1, List<prl_employee_details> emp, out int numberOfDaysWorked)
        {
            ...
            if (discontinueConfig.with_salary == "Y")
            {
                ...
                basicSalaryAmount = ((emp[0].basic_salary* (decimal) 0.60)/daysInMonth)*numberOfDaysWorked;
            }
        ...
        private DateTime GetDiscontinueDate(int empid)
        {
           ...
           return discontObj.discontinue_date.Date;
        }
        ...
        public ActionResult CompleteSettlement(FormCollection formCollection)
        {
            ...
            service.SettleEmployee(summary.EmployeeId,summary.EntitledCalculationDays,summary.DueCalculationDays,summary.BasicSalary,summary.DueSalary,lstAllowances,lstDeduction,lstBonus);
